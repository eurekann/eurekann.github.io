...
Test management: 	Jira, TestRail, Zephyr Scale, Qase
API testing: 		Postman, Swagger
Databases: 		MySQL, Adminer
Automation:		JavaScript, Playwright, Git, GitHub, CI/CD workflows
QA Methodologies: 	SDLC, STLC, Defect Lifecycle, Agile/Scrum, Requirements Analysis
